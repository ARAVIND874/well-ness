...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash" }); // மாடல் பெயரை இங்கே மாற்றவும்
        console.log('Calling gemini API with model:', "gemini-2.0-flash"); // console.log செய்தியை இங்கே மாற்றவும்
